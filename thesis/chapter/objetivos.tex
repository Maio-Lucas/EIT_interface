...
\item Desenvolver a aplicação EITinterface, utilizando os métodos de reconstrução Back-Projection (BP), Jacobiano (JAC) e GREIT implementados pela biblioteca de código aberto \texttt{pyEIT}, com interface interativa para alternância entre métodos e visualização comparativa dos resultados.

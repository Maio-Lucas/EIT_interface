...
\renewcommand{\notaDeRosto}
{
    Trabalho de Conclusão de Curso apresentado ao \centro{} da Universidade Federal do ABC como requisito parcial à obtenção do título de Bacharel em Engenharia Biomédica.
...
{
    \singlespacing
    Relatório apresentado para parte prática da disciplina de \disciplina, tendo sido \professor.
}
